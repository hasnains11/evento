import 'package:evento/pages/forgot_password_page.dart';
                  ...
                  children: [
                        ...
                        child: Column(
                          children: [
                            ...
                            buildTextField(
                              ...
                              size,
                                  (valuegender) {
                                if (valuegender.toString().toLowerCase() ==
                                    "male" ||
                                    valuegender.toString().toLowerCase() ==
                                        'female') {
                                  buildSnackError(
                            ...
                            buildTextField(
                              ...
                              size,
                                  (phone) {
                                RegExp phoneRegex =
                                RegExp(r'^(\+92|0)?3[0-4]\d{8}$');
                                if (!phoneRegex.hasMatch(phone)) {
                                  buildSnackError("Phone number is Not valid",
                                      context, size);
                                  return '';
                                }
                                return null;
                          ...
                          if (register) {
                            ...
                            if (_emailKey.currentState!.validate()) {
                              if (_passwordKey.currentState!.validate()) {
                                ...
                                print(_loading);
                                _handleSignIn();
                                String? status = await AuthService()
                    ...
                    AnimatedPadding(
                      ...
                      padding: EdgeInsets.only(
                        top:
                        register ? size.height * 0.025 : size.height * 0.15,
                      ),
                      child: Row(
